...
def ensure_config_dir():
    ...
    This directory is created on import so users have a known location
    to store their JSON datasheet files.
...
# Call the function to ensure directory exists on import
ensure_config_dir()
